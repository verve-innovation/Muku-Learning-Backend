...
export function CrudModal({ isOpen, title, onClose, children }: CrudModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black/70 backdrop-blur-[5px] flex justify-center items-center z-1000">
      <div className="bg-bg-card border border-border-color rounded-[20px] p-7.5 w-[90%] max-w-125 shadow-[0_15px_30px_rgba(0,0,0,0.5)] animate-[modalScale_0.3s_ease-out] max-h-[90vh] overflow-y-auto">
